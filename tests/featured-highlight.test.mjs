...
test("o destaque apresenta o ensaio de Bill Gates e preserva a entrevista no histórico", () => {
  ...
  assert.match(app, /assetUrl\("covers\/gates-ia-contradicoes-2026-08-29-v3\.png"\)/);
  assert.match(app, /Ilustração editorial que contrapõe usos sociais articulados e riscos fragmentados/);
  assert.match(app, /ampliar e transformar o acesso à saúde, educação, agricultura e ciência/);
  ...
  assert.ok(fs.existsSync("public/covers/gates-ia-contradicoes-2026-08-29-v3.png"));
});
